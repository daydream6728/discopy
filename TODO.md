...
- [x] Respell the declarations of `abc` and `test/axioms.py`, drop the
      module-level alphabet `A` to `Z` and its imports
- [WIP] @session_01UrSNrBcfEnb46fFG9LYRPo-2026-09-19 17:55 `ty check` green, `pflake8`, pytest, CHANGELOG
