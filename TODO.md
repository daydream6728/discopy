...
- [ ] The parametric construction: `Agentic[C]`, `Prompt`, `lift` and `downgrade`
- [ ] Assembling an answer into a diagram: `from_step` and `from_layers`
- [ ] Calling the model: `question` and `query`
- [ ] Refinement and planning: `Prompt.refine`, `Diagram.refine`, `Diagram.plan`
- [ ] Docs, changelog and a green CI
