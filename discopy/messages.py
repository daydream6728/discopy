...
WRONG_ARITY = "Expected pairs of arity {}, got {} instead."
NOT_ENDO = "Expected a relation on one boundary, got {} instead."
NOT_IN_DICTIONARY = "{} is outside the dictionary of class constructs."
