...
class Diagram(frobenius.Diagram):
    ...
    def generators(cls) -> dict[str, Rule]:
        """
        A pregroup diagram is generated by the words of :data:`VOCABULARY`
        and the cups that reduce them, so that :meth:`strategy` draws
...
VOCABULARY = (
    Word('Alice', Ty('n')), Word('Bob', Ty('n')),
    Word('loves', Ty('n').r @ Ty('s') @ Ty('n').l))
